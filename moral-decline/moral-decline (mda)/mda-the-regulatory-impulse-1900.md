...
## I. Executive Summary: The Moral Crucible of the Foundation Era {#i.-executive-summary-the-moral-crucible-of-the-foundation-era .font-display .text-2xl .font-semibold .text-white .tracking-wide .uppercase}
::::
...
::::::::::::::: {.grid .grid-cols-2 .md:grid-cols-4 .gap-4 .my-10}
::::: {.data-callout .rounded-xl .p-5 .stat-glow .text-center}
::: {.font-display .text-3xl .font-bold .text-amber .mb-1}
88%
:::

::: {.font-sans .text-xs .text-gray-500 .uppercase .tracking-wider}
...
## II. The Progressive Imperative: Setting the Moral Stage (1900--1910) {#ii.-the-progressive-imperative-setting-the-moral-stage-19001910 .font-display .text-2xl .font-semibold .text-white .tracking-wide .uppercase}
::::

### The Context of American Ascendancy {#the-context-of-american-ascendancy .font-display .text-lg .font-semibold .text-gray-300 .tracking-wide .uppercase .mb-4}
...
### Morality as a Tool of Social Engineering {#morality-as-a-tool-of-social-engineering .font-display .text-lg .font-semibold .text-gray-300 .tracking-wide .uppercase .mb-4}
...
[Domain Analysis]{.font-mono .text-xs .text-accent/70 .uppercase .tracking-widest}
:::

## III. Family Structure and Marital Stability {#iii.-family-structure-and-marital-stability .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
:::::::::::::::::: {.bg-card .rounded-xl .p-8 .border .border-amber/10 .mb-6}
::: part-label-data
...
::::: {.bg-dark .rounded-lg .p-4 .text-center .border .border-white/5}
::: {.font-mono .text-lg .font-bold .text-amber}
25.9
:::

::: {.font-sans .text-xs .text-gray-600 .mt-1}
...
::::: {.bg-dark .rounded-lg .p-4 .text-center .border .border-white/5 .stat-glow}
::: {.font-mono .text-lg .font-bold .text-amber}
88%
:::
...
### The Widening Divergence of Marital Disruption from Official Divorce Rates {#the-widening-divergence-of-marital-disruption-from-official-divorce-rates .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
::: {.pullquote .pl-6 .py-4 .mt-6 .rounded-r-lg}
...
## IV. Sexuality, Purity, and Regulatory Legislation {#iv.-sexuality-purity-and-regulatory-legislation .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
### The Passage and Immediate Judicial Expansion of the White Slave Traffic Act (Mann Act) of 1910 {#the-passage-and-immediate-judicial-expansion-of-the-white-slave-traffic-act-mann-act-of-1910 .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
::: {.data-callout .rounded-lg .p-5 .mt-6}
...
## V. Education and National Standardization {#v.-education-and-national-standardization .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
### Universal Public Secondary Education as the Engine of Civic and Moral Assimilation {#universal-public-secondary-education-as-the-engine-of-civic-and-moral-assimilation .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
## VI. Economic Foundations and Labor Ethics {#vi.-economic-foundations-and-labor-ethics .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
### The Eight-Hour Day as a Moral Right and the Shift from Moralizing Poverty to Addressing Systemic Exploitation {#the-eight-hour-day-as-a-moral-right-and-the-shift-from-moralizing-poverty-to-addressing-systemic-exploitation .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
## VII. Media, Technology, and Censorship {#vii.-media-technology-and-censorship .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
### The Formation of the National Board of Censorship (1909): Self-Regulation to Preempt State Control {#the-formation-of-the-national-board-of-censorship-1909-self-regulation-to-preempt-state-control .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
## VIII. Religious and Institutional Authority {#viii.-religious-and-institutional-authority .font-display .text-2xl .font-bold .text-white .tracking-wide .uppercase}
...
### The Institutionalization and Political Integration of the Social Gospel Movement {#the-institutionalization-and-political-integration-of-the-social-gospel-movement .font-display .text-base .font-semibold .text-white .tracking-wide .uppercase .mb-4}
...
## IX. Conclusion: Defining Characteristics of American Moral Development, 1900--1910 {#ix.-conclusion-defining-characteristics-of-american-moral-development-19001910 .font-display .text-2xl .font-semibold .text-white .tracking-wide .uppercase}
::::
...
::::::::::::: {.space-y-4 .mb-10}
:::: {.series-card .rounded-xl .p-6 .flex .items-start .gap-5}
[1]{.font-display .text-3xl .font-bold .text-accent/40 .w-8 .flex-shrink-0 .text-right .leading-none .mt-1}

::: {}
### Regulatory Purity and the Federalization of Morality {#regulatory-purity-and-the-federalization-of-morality .font-sans .font-semibold .text-white .text-sm .mb-2}
...
:::: {.series-card .rounded-xl .p-6 .flex .items-start .gap-5}
[2]{.font-display .text-3xl .font-bold .text-accent/40 .w-8 .flex-shrink-0 .text-right .leading-none .mt-1}

::: {}
### The Institutionalized Social Ethic {#the-institutionalized-social-ethic .font-sans .font-semibold .text-white .text-sm .mb-2}
...
:::: {.series-card .rounded-xl .p-6 .flex .items-start .gap-5}
[3]{.font-display .text-3xl .font-bold .text-accent/40 .w-8 .flex-shrink-0 .text-right .leading-none .mt-1}

::: {}
### The Crisis of Assimilation through Standardization {#the-crisis-of-assimilation-through-standardization .font-sans .font-semibold .text-white .text-sm .mb-2}
...
:::: {.series-card .rounded-xl .p-6 .flex .items-start .gap-5}
[4]{.font-display .text-3xl .font-bold .text-accent/40 .w-8 .flex-shrink-0 .text-right .leading-none .mt-1}

::: {}
### Co-Opted Authority in Mass Culture {#co-opted-authority-in-mass-culture .font-sans .font-semibold .text-white .text-sm .mb-2}
...
:::: {.series-card .rounded-xl .p-6 .flex .items-start .gap-5}
[5]{.font-display .text-3xl .font-bold .text-accent/40 .w-8 .flex-shrink-0 .text-right .leading-none .mt-1}

::: {}
### Concealed Domestic Strain {#concealed-domestic-strain .font-sans .font-semibold .text-white .text-sm .mb-2}
...
## X. Data Appendix: Key Indicators of the Foundation Era {#x.-data-appendix-key-indicators-of-the-foundation-era .font-display .text-2xl .font-semibold .text-white .tracking-wide .uppercase}
::::

::::: {.data-callout .rounded-xl .p-2 .stat-glow}
::: {.bg-dark/60 .rounded-lg .p-4 .mb-2}
...
:::::: {.section .mb-16 .works-cited}
:::: {.flex .items-center .gap-4 .mb-8}
::: {.w-10 .h-10 .rounded-lg .bg-accent/10 .flex .items-center .justify-center}
:::

## Works Cited {#works-cited .font-display .text-xl .font-semibold .text-white .tracking-wide .uppercase}
::::
