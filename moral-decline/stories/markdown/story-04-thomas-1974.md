...
::::::::::::::::::::: {.max-w-4xl .mx-auto}
:::: mb-16
## PART IV: THOMAS {#part-iv-thomas .story-header .text-sm .font-semibold .mb-2}

# The Breaking (1974) {#the-breaking-1974 .font-serif .text-6xl .text-white .mb-6}
...
::::::::::::::::: prose-body
## The World of 1974 {#the-world-of-1974 .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
- [-]{.text-accent .mt-1}Divorce rate: 4.6 per 1,000 population, up from 2.6 in 1950. California passed no-fault divorce in 1969. By 1974, most states have followed. You can now end a marriage because you want to.
- [-]{.text-accent .mt-1}Average age at first marriage: 23.1 for men, 21.1 for women. Holding steady - but what happens *after* marriage is changing.
- [-]{.text-accent .mt-1}Cohabitation: Still rare - only 1.1% of couples - but rising fast. The stigma is fading.
- [-]{.text-accent .mt-1}Church attendance: 40% weekly, down from 55% in 1958. The decline is accelerating.
- [-]{.text-accent .mt-1}Inflation: 11% in 1974. The economy is broken. You can work hard and fall behind.
- [-]{.text-accent .mt-1}Mothers working: 39% of mothers with children under 18 are in the workforce, up from 18% in 1950.
- [-]{.text-accent .mt-1}Television hours per day: 6+ in the average household.
- [-]{.text-accent .mt-1}Households with color TV: 50% (up from 0% in 1960).
:::
...
## Ohio, 1974 {#ohio-1974 .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## Jennifer {#jennifer .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## The Noise {#the-noise .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## The Conversation That Doesn\'t Happen {#the-conversation-that-doesnt-happen .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## The Virtues Lost {#the-virtues-lost .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## 1976 {#section .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## 1978 {#section-1 .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## 1980 {#section-2 .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## 1985 {#section-3 .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
## What Tommy Doesn\'t Know {#what-tommy-doesnt-know .font-display .text-3xl .text-white .mt-16 .mb-6 .uppercase .tracking-wide}
...
### Analyst\'s Commentary: The Phase Transition {#analysts-commentary-the-phase-transition .font-display .text-xl .text-amber .mt-10 .mb-4 .uppercase .tracking-wide}
