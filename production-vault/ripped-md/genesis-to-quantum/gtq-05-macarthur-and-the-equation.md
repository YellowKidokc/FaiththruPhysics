...
html_path: "genesis-to-quantum\gtq-05-macarthur-and-the-equation.html"
---
...
Camp | Describes | $s$ Transition | Mechanism | Calvinist | Effectual calling | -1 → 0 | Monergistic — $G$ alone opens the system | Arminian | Response/growth | 0 → +1 | Synergistic — $O$ and $G$ together build coherence
...
- [Free Will in Two Frames](gtq-04-free-will-two-frames.html) — the parent article introducing the $s$ parameter and the $dC/dt$ equation
- [The Three Pathways](gtq-06-three-pathways.html) — sibling tangent: the same $s$ values analyzed neurochemically; Augustine's four states match the three pathways
- [The Decoherence Curve](gtq-09-decoherence-curve.html) — the same coupling variable at civilizational scale; the lifespan floor mirrors the grace floor in the equation
- [The Trinity Timeline](gtq-13-trinity-timeline.html) — Pentecost as the moment when continuous Phase 2 grace became universally available
...
The two-phase resolution in formal language.

**The Coherence Equation

Two terms, two phases
            $$\frac{dC}{dt} = \alpha(s) \cdot G(1-C) - S \cdot C, \quad \alpha(s) = \frac{1+s}{2}$$
...
**Kill if:** Calvinist and Arminian proof texts fail to partition cleanly by phase under robust reading.

Suggestive

**Kill if:** the Romans 9:22-23 active/passive grammar is shown to be convention rather than meaningful theological signal.

Destructive

**Kill if:** the equation's dynamics force a position on perseverance, breaking the structural-neutrality claim.
