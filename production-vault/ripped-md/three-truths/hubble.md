---
title: "The Hubble Tension — The 5σ Crack in the Foundation"
source_type: "html_rip"
html_path: "three-truths\hubble.html"
---

# The Hubble Tension — The 5σ Crack in the Foundation
...
Two ways of measuring the expansion of the universe give two different answers. The disagreement is now at 5σ — the threshold for discovery. Something in the standard model is wrong.
...
[The Fine-Tuning Numbers The cosmological constant (Λ) is tuned to 1 in 10¹²⁰. Now the Hubble tension suggests it might not be constant at all. →](finetuning.html)
[Pre-Human Math The equations governing expansion were operative from the first Planck time. Where were they — and what were they tuned to? →](prehumanmath.html)
[PROP-COSMOS — 11 for 11 at 5.7σ Another anomaly in the data. Prophetic dates correlating with cosmological events at 5.7 sigma. →](propcosmos.html)

[← Home](index.html)
[← Fine-Tuning](finetuning.html)
[PROP-COSMOS →](propcosmos.html)
