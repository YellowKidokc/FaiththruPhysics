...
html_path: "three-truths\godel.html"
---
...
**Any powerful enough math system can talk about itself.**
...
**So you can build a statement that says: "This statement cannot be proven in this system."**
...
**If G is false, the system is inconsistent.**
...
**If G is true, the system is incomplete.**
...
**Therefore: the system is either inconsistent or incomplete. Pick one.**
...
**The deep point:** Gödel didn't prove God exists. He proved that *no closed system can ground itself*. What grounds reality must therefore be outside reality. The properties of that ground — necessary, self-existent, the source of logical consistency — are precisely what theology has always described.
...
[Terminus Sui — All Five Proofs Together Gödel is one of five. Tarski, Turing, Second Law, and Landauer all proved the same structural limit from different directions. →](terminus.html)
[The Divine Irony Gödel proved the system can't prove its own ground. That's not a problem — it's the signature of a ground that's truly external. →](irony.html)
[Pre-Human Math If the system can't ground itself, and the math was there before humans — where was the ground? →](prehumanmath.html)

[← Home](index.html)
[← Terminus Sui](terminus.html)
