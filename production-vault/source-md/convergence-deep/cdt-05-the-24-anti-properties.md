---
title: "The 24 Anti-Properties | Deep Theory · Theophysics"
source_type: "verified_markdown"
html_path: "convergence-deep\cdt-05-the-24-anti-properties.html"
source_md_path: "D:\VAULT_USED_SOURCES\___THE CONVERGENCE TX 6.6\THE_24_ANTI_PROPERTIES.md"
...
**1. Necessary → Contingent.** Truth couldn't be otherwise — it holds across every possible world, every reference frame, every conceivable situation. The adversary's claims hold only under specific conditions. True *if* you accept the framing. True *if* the assumptions stay put. Change the modal frame — pull on the assumptions — and the claim collapses. Truth has no escape clause. His claims are nothing but escape clauses.

**2. Non-contingent → Entirely contingent on physical facts.** Distinct from #1: this is empirical fragility, not modal fragility. Mathematical truth doesn't change when the world changes — 2+2=4 holds whether the universe is hot or cold, full or empty, alive or dead. The adversary's claims are tied to the physical now: this brain state, this institutional moment, this material configuration. Shift the substrate and the "truth" shifts with it. Truth is independent of matter; he is utterly dependent on it.
...
**5. Time-invariant → Time-bound.** Truth holds across time without renewal. Everything he offers has an expiration date. The pleasure that doesn't last. The solution that works for now. The framework that's current until it isn't. Time alone — without anyone attacking the claim — kills it. Eternity is a property of the invariant. Time is the adversary's enemy.
...
**14. Non-perishable → Perishable under pressure.** Distinct from #5: even within their shelf-life, the adversary's constructions don't survive sustained examination. Honest scrutiny degrades them. Adversarial review degrades them. The closer you look, the more they unravel — not because time has passed but because they couldn't take the weight. The identity constructed on opposition to the invariant cracks under the first real test, not the thousandth. Truth invites pressure and gains structure from it. His offerings shed structure with every test.
