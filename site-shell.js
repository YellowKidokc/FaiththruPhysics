...
(function () {
  ...
  const STYLES = `
    ...
    /* Math Translation Layer Global Toggle */
    .mtl-toggle-btn {
  ...
  function syncMTLState() {
    ...
    // Canonical shell compatibility: ftp-canonical-shell.html reveals
    // .ftp-mtl-content via body.mtl-mode â€” keep both vocabularies in sync.
    ...
    // Make sure details blocks open/close
  ...
  function injectTitleRigMtlButton() {
    ...
    btn.innerHTML = 'Math Translation';

    btn.addEventListener('click', toggleMTL);

    // Append to H1 if it's display block, or insert after
    h1.appendChild(btn);
  }
