...
**Concept A:** A valid scientific theory must generate predictions that can, in principle, be shown false. The gold standard is 6-sigma (p < 3.4 × 10⁻⁶). Theories that cannot be falsified are not scientific (Popper). The method: hypothesize → predict → test → revise or reject.
